  ...
  team: [
    {
      ...
      role: "CEO & Co-Founder",
      description: "Visionary leader with 12+ years in tech innovation and digital transformation.",
    ...
    },
    {
      ...
      description: "Full-stack architect specializing in scalable solutions and emerging technologies.",
    ...
    },
    {
      name: "Syed Hannan",
      role: "Head of Design",
      description: "Creative director focused on user-centered design and brand experiences.",
    ...
    },
    {
      name: "Suresh Kumar",
      role: "Lead Developer",
      description: "Senior developer with expertise in modern web technologies and mobile apps.",
      expertise: ["React/Next.js", "Mobile Development", "DevOps"],
      color: "green"
    }
  ],
  testimonials: [
    {
      quote: "TechByte delivered exceptional results that transformed our business operations. Their expertise in AI and web development is unmatched.",
      name: "David Thompson",
      company: "Innovation Corp",
      role: "Chief Technology Officer"
    },
    {
      quote: "Working with TechByte was seamless. They understood our vision perfectly and delivered a solution that exceeded all expectations.",
      name: "Lisa Wang", 
      company: "StartupFlow",
      role: "CEO"
    },
    {
      quote: "The level of professionalism and technical expertise at TechByte is outstanding. They're our go-to partner for all digital projects.",
      name: "Robert Garcia",
  ...
  faqs: [
    {
      ...
      answer: "Project timelines vary depending on complexity and scope. A standard website typically takes 4-8 weeks, while complex applications can take 3-6 months. We provide detailed timelines after our initial consultation and requirements analysis."
    },
    {
      question: "How much does a project cost?",
      answer: "We offer custom quotes based on your specific requirements, project scope, and timeline. Our pricing is competitive and transparent. Contact us for a free consultation and detailed estimate tailored to your needs."
    },
    {
      question: "Do you provide ongoing support and maintenance?",
      answer: "Yes! We offer comprehensive support and maintenance packages to ensure your solution remains secure, updated, and performing optimally. This includes regular updates, security monitoring, performance optimization, and feature enhancements."
    },
    {
      question: "What technologies do you specialize in?",
      answer: "We specialize in modern web frameworks (React, Next.js, Vue.js), mobile development (React Native, Flutter), AI/ML technologies, cloud platforms (AWS, Azure, GCP), and emerging technologies like AR/VR and IoT."
    },
    {
      question: "Can you help with digital transformation initiatives?",
      answer: "Absolutely! We have extensive experience helping organizations modernize their technology stack, streamline processes, and implement digital solutions that drive growth and efficiency. We work closely with your team to ensure smooth transitions."
    }
  ]
};
...
const ThreeDBackground = {
  ...
  createObjects() {
    ...
    const geometry = new THREE.TorusKnotGeometry(1.2, 0.4, 64, 16); // Reduced segments for performance
    ...
    // Create particle system with reduced count for performance
    const particlesGeometry = new THREE.BufferGeometry();
    const particlesCount = window.innerWidth < 768 ? 2000 : 3000; // Responsive particle count
  ...
  setupEventListeners() {
    // Mouse movement
    const handleMouseMove = Utils.throttle((event) => {
    ...
    const handleScroll = Utils.throttle(() => {
      ...
      if (this.mainObject && scrollY > 0) {
        this.mainObject.position.y = scrollY * 0.002;
      }
    }, 16);
  ...
  fallbackBackground() {
    // Fallback for when Three.js fails
    if (this.canvas) {
...
const Navigation = {
  ...
  setupSmoothScrolling() {
    ...
    document.addEventListener('click', (e) => {
      ...
      // Remove the # and find the target element
...
const ServicesManager = {
  ...
  getServiceIcon(iconType) {
    const icons = {
      code: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l-4 4-4-4M6 16l-4-4 4-4"></path>',
      ...
      cloud: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3 3V10"></path>',
      design: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zM7 3V1m0 20v-2m4-8h6a2 2 0 012 2v6a2 2 0 01-2 2h-6"></path>',
      transform: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path>'
    };
  ...
  populateServices() {
    ...
    servicesGrid.innerHTML = APP_DATA.services.map((service, index) => `
      <article class="service-card" data-aos="fade-up" data-aos-delay="${100 * (index + 1)}">
...
const PortfolioManager = {
  ...
  populatePortfolio() {
    ...
    portfolioGrid.innerHTML = APP_DATA.projects.map((project, index) => `
      <article class="project-card" data-aos="fade-up" data-aos-delay="${100 * (index + 1)}">
        ...
        <div class="project-content">
          <div class="project-header">
            ...
            <h4 class="project-subtitle">${project.title}</h4>
          ...
          <div class="project-meta">
            ...
            <div class="project-meta-item">
              ...
              <div class="project-meta-value">${project.teamSize}</div>
            </div>
          </div>
          ...
          <div class="project-testimonial">
            <p class="project-testimonial-quote">"${project.testimonial}"</p>
            <p class="project-testimonial-author">— ${project.client}</p>
          </div>

          <div class="project-actions">
            <button class="btn btn--primary btn--sm project-details-btn" data-project-id="${project.id}">
              View Details
            </button>
            <button class="btn btn--outline btn--sm project-case-study-btn" data-project-id="${project.id}">
              Case Study
            </button>
          </div>
        </div>
  ...
  bindProjectEvents() {
    ...
    document.addEventListener('click', (e) => {
      ...
      if (e.target.classList.contains('project-case-study-btn')) {
        const projectId = parseInt(e.target.getAttribute('data-project-id'));
        this.showCaseStudy(projectId);
      }
    });
  },
...
const TeamManager = {
  ...
  populateTeam() {
    ...
    teamGrid.innerHTML = APP_DATA.team.map((member, index) => `
      <article class="team-card" data-aos="fade-up" data-aos-delay="${100 * (index + 1)}">
        <div class="team-avatar team-avatar--${member.color}">
...
const TestimonialsSlider = {
  init() {
    ...
    this.prevButton = document.querySelector('.testimonial-prev');
    this.nextButton = document.querySelector('.testimonial-next');
  ...
  populateTestimonials() {
    this.container.innerHTML = APP_DATA.testimonials.map(testimonial => `
  ...
  createDots() {
    ...
    this.dotsContainer.innerHTML = APP_DATA.testimonials.map((_, index) => `
  ...
  bindEvents() {
    ...
    const slider = this.container.closest('.testimonials-slider');
    if (slider) {
  ...
  goToNext() {
    this.currentIndex = (this.currentIndex + 1) % APP_DATA.testimonials.length;
    this.updateSlider();
    this.updateDots();
  },

  goToPrevious() {
    this.currentIndex = this.currentIndex === 0 ? APP_DATA.testimonials.length - 1 : this.currentIndex - 1;
    this.updateSlider();
    this.updateDots();
  },
...
const FAQ = {
  ...
  populateFAQ() {
    ...
    faqContainer.innerHTML = APP_DATA.faqs.map((faq, index) => `
      <div class="faq-item" data-aos="fade-up" data-aos-delay="${100 * (index + 1)}">
  ...
  bindEvents() {
    // Use event delegation for dynamically created FAQ items
    document.addEventListener('click', (e) => {
...
const ContactForm = {
  ...
  showError(message) {
    ...
    errorDiv.style.backgroundColor = 'rgba(var(--color-error-rgb), 0.1)';
  ...
  sendMessage() {
    ...
    setTimeout(() => {
      const responses = [
        ...
        "Great question! Let me connect you with one of our specialists who can provide detailed information about your project.",
        "I appreciate your interest in TechByte. Our team would love to discuss how we can help transform your business. Would you like to schedule a consultation?",
        "Thanks for contacting us! We specialize in cutting-edge solutions and would be excited to explore how we can help achieve your goals."
      ];
...
const ScrollToTop = {
  ...
  bindEvents() {
    ...
    const handleScroll = Utils.throttle(() => this.handleScroll(), 100);
    window.addEventListener('scroll', handleScroll);
  },
...
const LogoScroller = {
  init() {
    ...
    // If a user hasn't opted for reduced motion, add the animation
  ...
  init() {
    ...
    window.addEventListener('load', () => {
      setTimeout(() => {
        ...
        console.log(`TechByte page loaded in ${loadTime.toFixed(2)}ms`);
      }, 0);
    });
  }
};
